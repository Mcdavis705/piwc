  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        boxShadow:
          "0 10px 20px rgba(0, 0, 0, 0.15), 0 0 0 2px rgba(99, 102, 241, 0.3)", // Soft shadow and ring pulse
    ...
    >
      ...
      <p className="text-sm text-gray-500 line-clamp-4 pt-4 border-t border-gray-100 mt-auto">
        {description}
      </p>
    </motion.div>
  );
